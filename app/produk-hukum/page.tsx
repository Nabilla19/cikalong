        ...
        <section className="section bg-light flex-1">
          <div className="container">
            <div className="text-center mb-12">
              <h1 className="section-title text-center">Produk Hukum</h1>
              <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Kumpulan peraturan dan produk hukum Desa Cikalong</p>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              {produk?.map((item: any) => (
                <div key={item.id} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:shadow-md transition-shadow">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-lg flex items-center justify-center shrink-0 text-xl">
                      📄
                    </div>
                    <div>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-lg font-medium transition-colors text-sm shrink-0"
                  >
                    Buka Dokumen
                  </a>
                </div>
              ...
              {(!produk || produk.length === 0) && (
                <div className="text-center py-12 bg-white rounded-xl border border-dashed border-gray-200">
                  <p className="text-gray-500">Belum ada produk hukum yang diunggah.</p>
                </div>
              )}
            </div>
          </div>
