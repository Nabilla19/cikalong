        ...
        <div className="container">
          ...
          <div className="card mt-12 mb-12">
            ...
            <div className="sambutan-text text-gray-700 leading-relaxed text-center max-w-4xl mx-auto px-4 md:px-8">
              <p className="mb-4 text-center">Assalamu’alaikum Warahmatullahi Wabarakatuh,<br/>Salam sejahtera,</p>
              <p className="mb-4 text-center">Selamat datang di website resmi Desa Cikalong.</p>
              <p className="mb-4 text-center">Website ini kami hadirkan sebagai sarana informasi, komunikasi, dan transparansi pelayanan publik kepada masyarakat.</p>
              <p className="mb-4 text-center">Dengan semangat <strong>"Ngahiji Ku Rasa, Ngahaja Ku Karsa, Ngajayakeun Cikalong"</strong>, mari kita bersama membangun desa yang maju, mandiri, dan berbudaya.</p>
              <p className="mb-4 text-center">Terima kasih atas kunjungan Anda. Saran dan masukan sangat kami harapkan demi kemajuan bersama.</p>
              <p className="mb-6 text-center">Wassalamu’alaikum Warahmatullahi Wabarakatuh.</p>
              <p className="text-xl font-bold text-gray-900 mt-2 pb-4 text-center">Ruspandi</p>
            </div>
          </div>
